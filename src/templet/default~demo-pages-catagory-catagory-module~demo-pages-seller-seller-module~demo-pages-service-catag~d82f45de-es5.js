...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~demo-pages-catagory-catagory-module~demo-pages-seller-seller-module~demo-pages-service-catag~d82f45de"], {
  /***/
  ...
  function srcAppServiceApiApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function ApiService(http) {
        ...
        this.header2 = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]({
      ...
      _createClass2(ApiService, [{
        ...
        key: "updateSeller",
        value: function updateSeller(data, id) {
        ...
        key: "removeSeller",
        value: function removeSeller(id) {
          return this.http["delete"](this.baseUrl + 'api/auth/seller/' + id, {
            headers: this.header
          });
        }
      }, {
        ...
        key: "updateproduct",
        value: function updateproduct(data, id) {
          return this.http.put(this.baseUrl + 'api/product/' + id, data, {
            headers: this.header
          });
        }
      }, {
        ...
        key: "updateCatogory",
        value: function updateCatogory(data, id) {
          return this.http.put(this.baseUrl + 'api/catogory/' + id, data, {
            headers: this.header
          });
        }
      }, {
        key: "removeCatogory",
        value: function removeCatogory(id) {
          return this.http["delete"](this.baseUrl + 'api/catogory/' + id, {
            headers: this.header
          });
        }
      }, {
        key: "getSubCatogory",
        value: function getSubCatogory() {
          return this.http.get(this.baseUrl + 'api/subcatogory', {
            headers: this.header
          });
        }
      }, {
        key: "addSubCatogory",
        value: function addSubCatogory(data) {
          return this.http.post(this.baseUrl + 'api/subcatogory', data, {
            headers: this.header
          });
        }
      }, {
        key: "updateSubCatogory",
        value: function updateSubCatogory(data, id) {
          return this.http.put(this.baseUrl + 'api/subcatogory/' + id, data, {
            headers: this.header
          });
        }
      }, {
        key: "removeSubCatogory",
        value: function removeSubCatogory(id) {
          return this.http["delete"](this.baseUrl + 'api/subcatogory/' + id, {
            headers: this.header
          });
        }
      }, {
        ...
        key: "Updatesrvice",
        value: function Updatesrvice(data, id) {
        ...
        key: "serviceDelete",
        value: function serviceDelete(id) {
        ...
        key: "postServiceCategory",
        value: function postServiceCategory(data) {
          return this.http.post(this.baseUrl + 'api/servicecat/', data, {
            headers: this.header
          });
        }
      }, {
        key: "delteServiceCategory",
        value: function delteServiceCategory(id) {
          return this.http["delete"](this.baseUrl + 'api/servicecat/' + id, {
            headers: this.header
          });
        }
      }, {
        key: "updateServiceCategory",
        value: function updateServiceCategory(data, id) {
          return this.http.put(this.baseUrl + 'api/servicecat/' + id, data, {
            headers: this.header
          });
        }
      }, {
        key: "getUsercart",
        value: function getUsercart(id) {
...
//# sourceMappingURL=default~demo-pages-catagory-catagory-module~demo-pages-seller-seller-module~demo-pages-service-catag~d82f45de-es5.js.map