...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["demo-pages-user-user-module"], {
  ...
  /***/
  function srcAppDemoPagesUserCartCartComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_service_api_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var src_app_pipe_srink_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/pipe/srink.pipe */
    ...
    function CartComponent_tr_20_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("src", "", ctx_r115.imageUrl + item_r116.product.productImage[0], " ", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](item_r116.product.productName);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](9, 3, item_r116.product.productInfo), " ");
      }
    }
    ...
    /*#__PURE__*/
    function () {
      function CartComponent(activeRoute, api) {
      ...
      _createClass(CartComponent, [{
        ...
        value: function getcart() {
          ...
          this.api.getUsercart(this.userId).subscribe(function (res) {
    ...
    CartComponent.ɵfac = function CartComponent_Factory(t) {
      return new (t || CartComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_service_api_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]));
    };
    ...
    CartComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 22,
      vars: 2,
      consts: [[1, "row"], [1, "col-sm-12"], ["cardClass", "user-profile-list", 3, "hidHeader"], [1, "dt-responsive", "table-responsive"], ["datatable", "", 1, "table", "table-striped", "row-border", "table-hover"], [4, "ngFor", "ngForOf"], [1, "d-inline-block", "align-middle"], ["alt", "user image", 1, "img-radius", "align-top", "m-r-15", 2, "width", "40px", 3, "src"], [1, "d-inline-block"], [1, "m-b-0"], [1, "badge", "badge-light-success"], [1, "overlay-edit"], ["type", "button", 1, "btn", "btn-icon", "btn-success"], [1, "feather", "icon-check-circle"], ["type", "button", 1, "btn", "btn-icon", "btn-danger"], [1, "feather", "icon-trash-2"]],
      ...
      directives: [_theme_shared_components_card_card_component__WEBPACK_IMPORTED_MODULE_4__["CardComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"]],
      pipes: [src_app_pipe_srink_pipe__WEBPACK_IMPORTED_MODULE_6__["SrinkPipe"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CartComponent, [{
        ...
        return [{
          ...
          type: src_app_service_api_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppDemoPagesUserUserRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var UserRoutingModule =
    /*#__PURE__*/
    _createClass(function UserRoutingModule() {
  ...
  /***/
  function srcAppDemoPagesUserUserComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function UserComponent_tr_20_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function UserComponent_tr_20_Template_input_change_14_listener($event) {
          ...
          return ctx_r119.statusHandel($event);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserComponent_tr_20_Template_button_click_21_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r120);
          ...
          return ctx_r121.remove(item_r118._id);
        });
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](item_r118.username);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](item_r118.email);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("routerLink", "cart/" + item_r118._id);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](4);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("id", item_r118._id);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("checked", item_r118.satate);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("for", item_r118._id);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("ngClass", "", item_r118.satate ? "badge-light-success" : "badge-light-danger", "\n                  ");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("", item_r118.satate ? "Active" : "Disabled", " ");
      }
    }
    ...
    /*#__PURE__*/
    function () {
      function UserComponent(toastr, fb, api, spiner, route, activeRoute) {
        ...
        value: function getseller() {
          ...
          this.api.getUser(this.skip, this.limit, this.serch).subscribe(function (res) {
            ...
            if (res.response == 'success') {
              ...
              _this3.toastr.error('Somthing Wrong!');
            }

            if (res.count == 0) {
              _this3.spiner.hide();

              _this3.toastr.info('Seller Not Found!');
            }
          });
        }
      }, {
        ...
        value: function statusHandel(e) {
          ...
          this.api.updateSeller(obj, e.target.id).subscribe(function (res) {
            if (res.response = 'success') {
              ...
              _this4.toastr.success('Seller Update!');
              ...
              _this4.toastr.error('Somthing Wrong!');
            }
        ...
        value: function remove(id) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
            ...
            if (willDelete.dismiss) {} else {
              _this5.api.removeSeller(id).subscribe(function (res) {
                _this5.toastr.success('Product has been deleted!!');
    ...
    UserComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 35,
      vars: 8,
      consts: [[1, "row"], [1, "col-sm-12"], ["cardClass", "user-profile-list", 3, "hidHeader"], [1, "mb-3"], ["type", "text", "placeholder", "Search...", 1, "form-control", 3, "ngModel", "input"], [1, "dt-responsive", "table-responsive"], ["datatable", "", 1, "table", "table-striped", "row-border", "table-hover"], [2, "width", "100%"], [4, "ngFor", "ngForOf"], [1, "footer"], [1, "page-item"], [1, "mb-0", "px-3"], [1, "pagination"], ["href", "#", 1, "page-link", 3, "disabled", "click"], [1, "page-link", 3, "disabled", "click"], [1, "d-inline-block", "align-middle"], ["src", "../../../../assets/images/user/360_F_65772719_A1UV5kLi5nCEWI0BNLLiFaBPEkUbv5Fv.jpg", "alt", "user image", 1, "img-radius", "align-top", "m-r-15", 2, "width", "40px"], [1, "d-inline-block"], [1, "m-b-0"], [1, "btn", "btn-link", 3, "routerLink"], [1, "custom-control", "custom-switch"], ["type", "checkbox", 1, "custom-control-input", 3, "id", "checked", "change"], [1, "custom-control-label", 3, "for"], [1, "badge", 3, "ngClass"], [1, ""], ["type", "button", 1, "btn", "btn-icon", "btn-danger", 3, "click"], [1, "feather", "icon-trash-2"]],
      template: function UserComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function UserComponent_Template_input_input_4_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserComponent_Template_button_click_33_listener() {
            return ctx.nexts();
          });
  ...
  /***/
  function srcAppDemoPagesUserUserModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_pipe_srink_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! src/app/pipe/srink.pipe */
    "./src/app/pipe/srink.pipe.ts");

    var UserModule =
    /*#__PURE__*/
    _createClass(function UserModule() {
    ...
    UserModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _user_routing_module__WEBPACK_IMPORTED_MODULE_2__["UserRoutingModule"], src_app_theme_shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrModule"].forRoot()]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](UserModule, {
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _user_routing_module__WEBPACK_IMPORTED_MODULE_2__["UserRoutingModule"], src_app_theme_shared_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppPipeSrinkPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "SrinkPipe", function () {
      return SrinkPipe;
    });
    /* harmony import */
    ...
    function () {
      function SrinkPipe() {
        _classCallCheck(this, SrinkPipe);
      }

      _createClass(SrinkPipe, [{
        key: "transform",
        value: function transform(value) {
          var result = value.slice(0, 40);
          return result + "....";
        }
      }]);
    ...
    SrinkPipe.ɵfac = function SrinkPipe_Factory(t) {
      return new (t || SrinkPipe)();
    };

    SrinkPipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
      name: "srink",
      type: SrinkPipe,
      pure: true
    });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SrinkPipe, [{
...
//# sourceMappingURL=demo-pages-user-user-module-es5.js.map