    ...
    vV5l: function (t, e, n) {
      ...
      function u(t, e) {
        if (
          ...
          r["\u0275\u0275property"](
            "ngClass",
            r["\u0275\u0275pureFunction1"](4, s, n.nowTime == t.time)
          )("id", "timepicker-item-id-" + t.time)(
            "ngStyle",
            r["\u0275\u0275pureFunction4"](
              6,
              c,
              t.top,
              t.left,
              n.nowTime == t.time ? n.config.arrowStyle.color : "",
              n.nowTime == t.time
                ? n.config.arrowStyle.background
                : "transparent"
            )
          ),
            r["\u0275\u0275advance"](1),
            r["\u0275\u0275textInterpolate1"](" ", n.GetClockTime(t), " ");
        }
      }
          ...
          class t {
            ...
            ClockMaker(t) {
              const e = [],
                n = "minute" === t ? 60 : 12,
                r = "minute" === t ? 5 : 1;
              for (let i = "minute" === t ? 0 : 1; i <= n; i += r)
                if (60 !== i) {
                  const r = String(i),
                    o = 99 * Math.sin(2 * Math.PI * (i / n)),
                    s = 99 * Math.cos(2 * Math.PI * (i / n));
                  e.push({
                    time: r,
                    left: o + 124 - 17 + "px",
                    top: 124 - s - 17 + "px",
            ...
            TimeToString(t) {
              const { ampm: e, minute: n, hour: r } = t;
              let i = "PM" === e ? +r + 12 : +r;
              return (
                "AM" === e && 12 === i && (i = 0),
                24 === i && (i = 12),
            ...
            StringToTime(t) {
              ...
              return (
                (r = 0 === r ? 12 : r),
                { ampm: +e >= 12 ? "PM" : "AM", minute: +n, hour: r }
              );
            }
            CalcDegrees(t, e, n) {
              const r = t.currentTarget.offsetHeight / 2,
                i = Math.round(
              ...
              s += 2.5 * Math.PI;
              let c = Math.round((180 * s) / Math.PI);
              const u = c % n;
              return 0 === u
                ? c
          ...
          class t {
            constructor(t) {
              (this.core = t),
                ...
                (this.setArrow = (t) => {
                  t &&
                    ((this.clockType = t.type),
                    "minute" === this.clockType
                      ? (this.time.minute = t.time)
                      : (this.time.hour = t.time)),
                    this.rotationClass(
                      ("minute" === this.clockType
                        ? this.time.minute
                        : this.time.hour) *
                        ("minute" === this.clockType ? 6 : 30)
                    ),
                    this.setActiveTime();
                }),
                (this.rotationClass = (t) => {
                  this.degree = t;
                }),
                (this.getDegree = (t) => {
                  const e = "minute" === this.clockType ? 6 : 30,
                  ...
                  if (
                    ...
                    const r = this.core.CalcDegrees(t, n, e);
                    let i = this.time.hour,
                      o = this.time.minute;
                    "hour" === this.clockType
                      ? ((i = r / e), (i = i > 12 ? i - 12 : i))
                      : "minute" === this.clockType &&
                        ((o = r / e), (o = o > 59 ? o - 60 : o));
                    const s = this.config.rangeTime.start,
                      c = this.config.rangeTime.end,
                      u =
                        +s.split(":")[0] < 12
                          ? +s.split(":")[0]
                          : +s.split(":")[0] - 12,
                      ...
                      p = +s.split(":")[1],
                      l = +c.split(":")[1],
                      h = this.GetNowTime(i, this.time.ampm, o);
                    this.allowed.indexOf(h) > -1
                      ? ((this.time.hour = i),
                        (this.time.minute = o),
                        this.rotationClass(r),
                        this.setActiveTime())
                      : "hour" === this.clockType && i === u && o <= p
                      ? ((this.time.hour = u), (this.time.minute = p))
                      : "hour" === this.clockType &&
                        i === a &&
                        o >= l &&
                        ((this.time.hour = a), (this.time.minute = l));
                  }
                });
            }
            ParseStringToTime(t) {
            ...
            GetTime() {
              const t = this.core.TimeToString(this.time);
              this.subject.next(t);
            }
            setTime() {
              (this.isClicked = !1),
            ...
            GetNowTime(t, e, n) {
              return (12 === t && "AM" === e ? "0" : t) + ":" + n + " " + e;
            }
            checkBet() {
              const t = this.GetNowTime(
                this.time.hour,
                this.time.ampm,
                this.time.minute
              );
            ...
            setNewRotation() {
              const t = (this.time.minute / 60) * 360 + 360,
                e = 2 * t,
            ...
            GetMinute() {
              ...
              let t = this.time.minute.toString();
              return +t < 10 && (t = "0" + t), t;
            }
            GetHour() {
            ...
            GetClockTime(t) {
              return this.preference
                ? "hour" === this.clockType && this.preference.clockHour
                  ...
                  : "minute" === this.clockType && this.preference.clockMinute
                  ? this.preference.clockMinute(t.time)
                  : t.time
                : t.time;
            }
            GetLabel(t) {
              const e = { ok: "Ok", cancel: "Cancel" };
              return (
                this.preference &&
            ...
            return (
              ...
              (t.prototype.subscribe = function (t, e, n) {
                var r = this.operator,
                  i = (function (t, e, n) {
                    if (t) {
                      if (t instanceof z.Subscriber) return t;
                      if (t[N.rxSubscriber]) return t[N.rxSubscriber]();
                    }
                    return t || e || n
                      ? new z.Subscriber(t, e, n)
                      : new z.Subscriber(A);
                  })(t, e, n);
                if (
                  (r
              ...
              (t.prototype[W.observable] = function () {
                return this;
              }),
      ...
      var bt = function (t) {
        ...
        Mt = function (t, e, n, r) {
          ...
          if (kt(e)) {
            ...
            else if (e && "function" == typeof e[W.observable]) {
              var a = e[W.observable]();
      ...
      var qt = {
        ...
        Wt = (function (t) {
          function e(e, n) {
            ...
            this.iterator = (function (t) {
              var e = t[Ct.iterator];
              if (!e && "string" == typeof t) return new Lt(t);
            ...
            return (
              ...
              (e.prototype._subscribe = function (t) {
                var e = this.ish,
                  n = this.scheduler;
                return null == n
                  ? e[W.observable]().subscribe(t)
                  : e[W.observable]().subscribe(
                      new ee.ObserveOnSubscriber(t, n, 0)
                    );
              }),
              e
            );
        ...
        ie = { from: re.FromObservable.create },
        oe =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        se = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new ce(t, this.project, this.resultSelector, this.concurrent)
              );
            }),
            t
          );
        ...
        pe = function (t) {
          return (
            void 0 === t && (t = Number.POSITIVE_INFINITY), ue(ae, null, t)
          );
        },
        le = function () {
          return pe(1);
        ...
        he = {
          concat: function () {
            ...
            return 1 === t.length || (2 === t.length && bt(t[1]))
              ? ie.from(t[0])
              : le()(Ft.of.apply(void 0, t));
          },
        };
      Y.Observable.concat = he.concat;
      var fe =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        be = (function (t) {
          ...
          return (
            ...
            (e.prototype._subscribe = function (t) {
              return new de(t, this.observableFactory);
            }),
            e
          );
        })(Y.Observable),
      ...
      var ye =
        ...
        me = (function (t) {
          ...
          return (
            ...
            (e.prototype._subscribe = function (t) {
              return new ve(t, this.sources, this.resultSelector);
            }),
            e
          );
        })(Y.Observable),
      ...
      (Y.Observable.forkJoin = me.create), (Y.Observable.from = ie.from);
      var ge =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        we = (function (t) {
          ...
          return (
            ...
            (e.setupSubscription = function (t, n, r, i, o) {
              ...
              if (
                (function (t) {
                  return !!t && "[object NodeList]" === _e.call(t);
                })(t) ||
                (function (t) {
                  return !!t && "[object HTMLCollection]" === _e.call(t);
                })(t)
              )
      ...
      Y.Observable.fromEvent = we.create;
      var Oe =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
      ...
      (Y.Observable.fromEventPattern = ke.create),
        (Y.Observable.fromPromise = qt.PromiseObservable.create);
      var xe =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
      ...
      Y.Observable.generate = Se.create;
      var Pe =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
      ...
      var je = function (t) {
        ...
        Re = { async: new Ve.AsyncScheduler(Ne.AsyncAction) },
        Be =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        qe = (function (t) {
          function e(e, n) {
            void 0 === e && (e = 0),
              ...
              (this.period = e),
              (this.scheduler = n),
              (!je(e) || e < 0) && (this.period = 0),
              (n && "function" == typeof n.schedule) ||
                (this.scheduler = Re.async);
          }
          return (
            Be(e, t),
            (e.create = function (t, n) {
      ...
      Y.Observable.interval = qe.create;
      var ze = {
        merge: function () {
          for (var t = [], e = 0; e < arguments.length; e++)
            t[e - 0] = arguments[e];
          ...
          return (
            ...
            null === r && 1 === t.length && t[0] instanceof Y.Observable
              ? t[0]
              : pe(n)(new _t.ArrayObservable(t, r))
          );
        },
      };
      Y.Observable.merge = ze.merge;
      var We =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        Ye = {
          race: function () {
            ...
            return new _t.ArrayObservable(t).lift(new Le());
          },
          RaceOperator: Ue,
          RaceSubscriber: He,
        };
      Y.Observable.race = Ye.race;
      var De =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
      ...
      (Y.Observable.never = Ge.create), (Y.Observable.of = Ft.of);
      var Xe =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        Ke = {
          ...
          onErrorResumeNextStatic: function () {
            ...
            return (
              1 === t.length && x.isArray(t[0]) && (t = t[0]),
              (n = t.shift()),
              new re.FromObservable(n, null).lift(new $e(t))
            );
          },
        };
      Y.Observable.onErrorResumeNext = Ke.onErrorResumeNextStatic;
      var Ze =
        (d && d.__extends) ||
        function (t, e) {
          for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
          ...
          timer: (function (t) {
            function e(e, n, r) {
              void 0 === e && (e = 0),
                ...
                bt(r) || (r = Re.async),
                (this.scheduler = r),
                (this.dueTime = an(e) ? +e - this.scheduler.now() : e);
            }
            return (
              pn(e, t),
              (e.create = function (t, n, r) {
      ...
      function fn() {
        ...
        return (
          ...
          new _t.ArrayObservable(t).lift(new dn(n))
        );
      }
      var bn = fn,
        dn = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new mn(t, this.project));
            }),
            t
          );
        })(),
          ...
          return (
            ...
            (e.prototype._next = function (t) {
              ...
              x.isArray(t)
                ...
                : e.push(
                    "function" == typeof t[Ct.iterator]
                      ? new gn(t[Ct.iterator]())
                      : new wn(this.destination, this, t)
                  );
            }),
            (e.prototype._complete = function () {
        ...
        On = {
          zip: function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e - 0] = arguments[e];
            return function (e) {
              return e.lift.call(fn.apply(void 0, [e].concat(t)));
            };
          },
          zipStatic: bn,
          ZipOperator: yn,
      ...
      var kn =
        ...
        xn = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Cn(t, this.project, this.thisArg));
            }),
            t
          );
        })(),
      ...
      function Tn(t, e) {
        return (
          void 0 === e && (e = null),
          new Vn({ method: "GET", url: t, headers: e })
        );
      }
      function jn(t, e, n) {
        return new Vn({ method: "POST", url: t, body: e, headers: n });
      }
      function In(t, e) {
        return new Vn({ method: "DELETE", url: t, headers: e });
      }
      function En(t, e, n) {
        return new Vn({ method: "PUT", url: t, body: e, headers: n });
      }
      function An(t, e, n) {
        return new Vn({ method: "PATCH", url: t, body: e, headers: n });
      }
      var Nn = Sn(function (t, e) {
        return t.response;
      });
      function Fn(t, e) {
        return Nn(
          new Vn({ method: "GET", url: t, responseType: "json", headers: e })
        );
      }
      var Vn = (function (t) {
          function e(e) {
        ...
        Bn = (function (t) {
          ...
          return (
            ...
            (e.prototype.next = function (t) {
              this.done = !0;
              var e = this.destination,
                n = new qn(t, this.xhr, this.request);
              e.next(n);
            }),
            ...
            (e.prototype.setupEvents = function (t, e) {
              ...
              function o(t) {
                var e = o.subscriber,
                  ...
                  r = o.request;
                n && n.error(t), e.error(new Ln(this, r));
              }
              function s(t) {
                var e = s.subscriber,
                ...
                if (4 === this.readyState) {
                  ...
                  0 === i &&
                    ...
                    200 <= i && i < 300
                      ...
                      : (n && n.error(t),
                        e.error(new zn("ajax error " + i, this, r)));
                }
              }
              (t.ontimeout = o),
                (o.request = e),
                  ...
                  (t.onerror = r =
                    function (t) {
                      var e = r.progressSubscriber,
                        n = r.subscriber,
                        i = r.request;
                      e && e.error(t), n.error(new zn("ajax error", this, i));
                    }),
                  (r.request = e),
                  (r.subscriber = this),
      ...
      var Un =
        ...
        Dn = new ((function (t) {
          ...
          return Yn(e, t), e;
        })(Ve.AsyncScheduler))(Hn.QueueAction),
        Gn =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
            ...
            (e.prototype._subscribe = function (t) {
              ...
              this.hasError
                ...
                : (this.observers.push(t),
                  (e = new $.SubjectSubscription(this, t))),
                r && t.add((t = new ee.ObserveOnSubscriber(t, r)));
      ...
      function Zn(t) {
        return t.Object.assign || Kn;
      }
      var Qn = { assignImpl: Kn, getAssign: Zn, assign: Zn(O.root) },
        tr =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
          ...
          function e(e, n) {
            if (e instanceof Y.Observable) t.call(this, n, e);
              ...
              if (
                ...
                "string" == typeof e ? (this.url = e) : Qn.assign(this, e),
                !this.WebSocketCtor)
              )
          ...
          return (
            ...
            (e.prototype._connectSocket = function () {
              ...
              (r.onopen = function (e) {
                ...
                o && o.next(e);
                var s = t.destination;
                (t.destination = z.Subscriber.create(
                  function (t) {
      ...
      Y.Observable.webSocket = er.create;
      var nr =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        rr = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new ir(t, this.closingNotifier));
            }),
            t
          );
        })(),
        ...
        sr = (function () {
          function t(t, e) {
            (this.bufferSize = t),
              ...
              (this.subscriberClass = e && t !== e ? ur : cr);
          }
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
        ...
        hr = (function (t) {
          function e(e, n, r, i, o) {
            ...
            if (((this.timespanOnly = null == r || r < 0), this.timespanOnly))
              ...
              this.add(
                (s.closeAction = o.schedule(dr, n, {
                  subscriber: this,
                  context: s,
                }))
              ),
                this.add(o.schedule(br, r, c));
            }
          }
          return (
            ar(e, t),
            ...
            (e.prototype.onBufferFull = function (t) {
              ...
              if (
                ...
                this.add(
                  (t.closeAction = this.scheduler.schedule(fr, n, {
                    subscriber: this,
                    context: t,
                    bufferTimeSpan: n,
                  }))
      ...
      function br(t) {
        ...
        r.closed ||
          (r.add(
            (o.closeAction = i.schedule(dr, n, { subscriber: r, context: o }))
          ),
          this.schedule(t, e));
      }
      function dr(t) {
      ...
      Y.Observable.prototype.bufferTime = {
        bufferTime: function (t) {
          ...
          e >= 2 && (r = arguments[1]);
          var i = Number.POSITIVE_INFINITY;
          return e >= 3 && (i = arguments[2]), yr(t, r, i, n)(this);
        },
      }.bufferTime;
      var mr =
          (d && d.__extends) ||
        ...
        vr = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new gr(t, this.openings, this.closingSelector)
              );
            }),
            t
          );
      ...
      var kr =
        ...
        xr = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Cr(t, this.selector, this.caught));
            }),
            t
          );
        })(),
      ...
      (Y.Observable.prototype.catch = Sr), (Y.Observable.prototype._catch = Sr);
      ...
      var Pr = {
        concatStatic: he.concat,
        concat: function () {
          for (var t = [], e = 0; e < arguments.length; e++)
            t[e - 0] = arguments[e];
          return function (e) {
            return e.lift.call(he.concat.apply(void 0, [e].concat(t)));
          };
        },
      };
      (Y.Observable.prototype.concat = {
        ...
        concat: function () {
          for (var t = [], e = 0; e < arguments.length; e++)
            t[e - 0] = arguments[e];
          return Pr.concat.apply(void 0, t)(this);
        },
      }.concat),
      ...
      var Tr =
        ...
        jr = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Ir(t, this.predicate, this.source));
            }),
            t
          );
        })(),
      ...
      var Fr =
        ...
        Vr = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Rr(t, this.durationSelector));
            }),
            t
          );
        })(),
      ...
      var Br =
        ...
        qr = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new zr(t, this.dueTime, this.scheduler));
            }),
            t
          );
        })(),
      ...
      var Lr =
        ...
        Ur = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Hr(t, this.defaultValue));
            }),
            t
          );
        })(),
      ...
      Y.Observable.prototype.defaultIfEmpty = {
        defaultIfEmpty: function (t) {
          return void 0 === t && (t = null), Yr(t)(this);
        },
      }.defaultIfEmpty;
      var Dr =
          (d && d.__extends) ||
        ...
        Gr = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Xr(t, this.delay, this.scheduler));
            }),
            t
          );
        })(),
      ...
      Y.Observable.prototype.delay = {
        delay: function (t, e) {
          return (
            ...
            (function (t, e) {
              void 0 === e && (e = Re.async);
              var n = an(t) ? +t - e.now() : Math.abs(t);
              return function (t) {
                return t.lift(new Gr(n, e));
              };
            })(
              t,
              e
      ...
      var Jr =
        ...
        Kr = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Zr(t, this.delayDurationSelector));
            }),
            t
          );
        })(),
        ...
        Qr = (function (t) {
          ...
          return (
            Jr(e, t),
            (e.prototype._subscribe = function (t) {
              this.subscriptionDelay.subscribe(new ti(t, this.source));
            }),
            e
          );
        })(Y.Observable),
      ...
      Y.Observable.prototype.delayWhen = {
        delayWhen: function (t, e) {
          return (function (t, e) {
            return e
              ? function (n) {
                  return new Qr(n, e).lift(new Kr(t));
                }
              : function (e) {
      ...
      var ni = { minimalSetImpl: ei, Set: O.root.Set || ei() },
        ri =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        ii = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new oi(t, this.keySelector, this.flushes));
            }),
            t
          );
        })(),
      ...
      var si =
        ...
        ci = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new ui(t, this.compare, this.keySelector));
            }),
            t
          );
        })(),
      ...
      var pi =
        ...
        li = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new hi(t, this.nextOrObserver, this.error, this.complete)
              );
            }),
            t
          );
      ...
      (Y.Observable.prototype.do = fi), (Y.Observable.prototype._do = fi);
      var bi =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
      ...
      var mi =
        ...
        vi = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new gi(t, this.project, this.resultSelector));
            }),
            t
          );
        })(),
      ...
      var _i =
        ...
        wi = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new Oi(t, this.project, this.concurrent, this.scheduler)
              );
            }),
            t
          );
        ...
        Si = (function () {
          function t(t, e) {
            if (((this.index = t), (this.defaultValue = e), t < 0))
              throw new xi.ArgumentOutOfRangeError();
          }
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Pi(t, this.index, this.defaultValue));
            }),
            t
          );
        })(),
            ...
            (e.prototype._complete = function () {
              ...
              this.index >= 0 &&
                (void 0 !== this.defaultValue
                  ...
                  : t.error(new xi.ArgumentOutOfRangeError())),
                t.complete();
            }),
            e
          );
      ...
      var Mi =
        ...
        Ti = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new ji(t, this.predicate, this.thisArg));
            }),
            t
          );
        })(),
      ...
      var Ei =
        ...
        Ai = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Ni(t, this.callback));
            }),
            t
          );
        })(),
      ...
      (Y.Observable.prototype.finally = Fi),
        (Y.Observable.prototype._finally = Fi);
      var Vi =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        zi = {
          find: function (t, e) {
            ...
            return function (n) {
              return n.lift(new Ri(t, n, !1, e));
            };
          },
          FindValueOperator: Bi,
          FindValueSubscriber: qi,
        };
      Y.Observable.prototype.find = {
        find: function (t, e) {
          return zi.find(t, e)(this);
        },
      }.find;
      Y.Observable.prototype.findIndex = {
        findIndex: function (t, e) {
          return (function (t, e) {
            return function (n) {
              return n.lift(new zi.FindValueOperator(t, n, !0, e));
            };
          })(
            t,
            e
          ...
          return (
            ...
            (e.prototype._complete = function () {
              ...
              this.hasCompleted || void 0 === this.defaultValue
                ? this.hasCompleted || t.error(new Li.EmptyError())
        ...
        Ji = (function (t) {
          ...
          return (
            ...
            (e.prototype._group = function (t, e) {
              ...
              n ||
                (n = this.groups =
                  "string" == typeof e ? new Gi.FastMap() : new Di.Map());
              var r,
                i = n.get(e);
              ...
              if (!i) {
                (i = this.subjectSelector
                  ...
                  : new nt.Subject()),
                  n.set(e, i);
                var o = new Zi(e, i, this);
                if ((this.destination.next(o), this.durationSelector)) {
                  var s = void 0;
                  try {
                    s = this.durationSelector(new Zi(e, i));
                  } catch (c) {
                    return void this.error(c);
                  }
                  this.add(s.subscribe(new Ki(e, i, this)));
                }
              }
              i.closed || i.next(r);
            }),
          ...
          return (
            ...
            (e.prototype._subscribe = function (t) {
              var e = new E.Subscription(),
                ...
                r = this.groupSubject;
              return (
                n && !n.closed && e.add(new to(n)), e.add(r.subscribe(t)), e
              );
            }),
            e
          );
      ...
      Y.Observable.prototype.groupBy = {
        GroupedObservable: Qi,
        groupBy: function (t, e, n, r) {
          return (function (t, e, n, r) {
            return function (i) {
              return i.lift(new $i(t, e, n, r));
            };
          })(
            t,
            e,
      ...
      var co =
        ...
        uo = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new ao(t, this.durationSelector));
            }),
            t
          );
        })(),
      ...
      (Y.Observable.prototype.let = bo), (Y.Observable.prototype.letBind = bo);
      var yo =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        mo = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new vo(t, this.predicate, this.thisArg, this.source)
              );
            }),
            t
          );
      ...
      var go =
        ...
        _o = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new wo(t, this.value));
            }),
            t
          );
        })(),
      ...
      var Co =
        ...
        So = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new Po(t, this.accumulator, this.seed, this.hasSeed)
              );
            }),
            t
          );
        ...
        jo = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Io(t, this.total));
            }),
            t
          );
        })(),
        ...
        Eo = function (t) {
          return function (e) {
            return 0 === t ? new vt.EmptyObservable() : e.lift(new jo(t));
          };
        },
        Ao = function (t, e) {
          return arguments.length >= 2
            ? function (n) {
                return H.pipe(Mo(t, e), Eo(1), Yr(e))(n);
              }
            : function (e) {
                return H.pipe(
                  Mo(function (e, n, r) {
      ...
      var No = {
        mergeStatic: ze.merge,
        merge: function () {
          for (var t = [], e = 0; e < arguments.length; e++)
            t[e - 0] = arguments[e];
          return function (e) {
            return e.lift.call(ze.merge.apply(void 0, [e].concat(t)));
          };
        },
      };
      (Y.Observable.prototype.merge = {
        ...
        merge: function () {
          for (var t = [], e = 0; e < arguments.length; e++)
            t[e - 0] = arguments[e];
          return No.merge.apply(void 0, t)(this);
        },
      }.merge),
        (Y.Observable.prototype.mergeAll = {
          mergeAll: function (t) {
            return void 0 === t && (t = Number.POSITIVE_INFINITY), pe(t)(this);
          },
        }.mergeAll);
      var Fo = function (t, e, n) {
        return (
          void 0 === n && (n = Number.POSITIVE_INFINITY), ue(t, e, n)(this)
        );
      };
      (Y.Observable.prototype.mergeMap = Fo),
        (Y.Observable.prototype.flatMap = Fo);
      var Vo =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        Ro = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new Bo(t, this.ish, this.resultSelector, this.concurrent)
              );
            }),
            t
          );
      ...
      (Y.Observable.prototype.flatMapTo = qo),
        (Y.Observable.prototype.mergeMapTo = qo);
      var zo =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        Wo = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new Lo(t, this.accumulator, this.seed, this.concurrent)
              );
            }),
            t
          );
      ...
      var Uo =
              ...
              return (
                t ||
                  ...
                  (t = this._connection = new E.Subscription()).add(
                    this.source.subscribe(new Zo(this.getSubject(), this))
                  ),
                  t.closed
        ...
        Qo =
          ...
          { ConnectableObservable: $o, connectableObservableDescriptor: Ko }),
        ts = (function () {
          function t(t, e) {
        ...
        es = function (t, e) {
          return function (n) {
            ...
            if (
              ...
              return n.lift(new ts(r, e));
            var i = Object.create(n, Qo.connectableObservableDescriptor);
      ...
      (Y.Observable.prototype.multicast = {
        ...
        (Y.Observable.prototype.observeOn = {
          observeOn: function (t, e) {
            return void 0 === e && (e = 0), ee.observeOn(t, e)(this);
          },
        }.observeOn),
        (Y.Observable.prototype.onErrorResumeNext = {
          onErrorResumeNext: function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e - 0] = arguments[e];
            return Ke.onErrorResumeNext.apply(void 0, t)(this);
          },
        }.onErrorResumeNext);
      var ns =
          (d && d.__extends) ||
      ...
      Y.Observable.prototype.pluck = {
        pluck: function () {
          for (var t = [], e = 0; e < arguments.length; e++)
            t[e - 0] = arguments[e];
          return cs.pluck.apply(void 0, t)(this);
        },
      }.pluck;
      ...
      Y.Observable.prototype.publishBehavior = {
        publishBehavior: function (t) {
          return (function (t) {
            return function (e) {
              return es(new as.BehaviorSubject(t))(e);
            };
          })(t)(this);
        },
      }.publishBehavior;
      ...
      Y.Observable.prototype.publishLast = {
        publishLast: function () {
          return (t = this), es(new it.AsyncSubject())(t);
          var t;
        },
      }.publishLast;
      var ps = {
        race: function () {
          ...
          return function (e) {
            return (
              1 === t.length && x.isArray(t[0]) && (t = t[0]),
              e.lift.call(Ye.race.apply(void 0, [e].concat(t)))
            );
          };
        },
      };
      (Y.Observable.prototype.race = {
        ...
        race: function () {
          for (var t = [], e = 0; e < arguments.length; e++)
            t[e - 0] = arguments[e];
          return ps.race.apply(void 0, t)(this);
        },
      }.race),
        (Y.Observable.prototype.reduce = {
          reduce: function (t, e) {
            return arguments.length >= 2 ? Ao(t, e)(this) : Ao(t)(this);
          },
        }.reduce);
      var ls =
          (d && d.__extends) ||
        ...
        hs = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new fs(t, this.count, this.source));
            }),
            t
          );
        })(),
      ...
      var bs =
        ...
        ds = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new ys(t, this.notifier, e));
            }),
            t
          );
        })(),
      ...
      var ms =
        ...
        vs = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new gs(t, this.count, this.source));
            }),
            t
          );
        })(),
      ...
      var _s =
        ...
        ws = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Os(t, this.notifier, this.source));
            }),
            t
          );
        })(),
      ...
      var Ss =
        ...
        Ps = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Ms(t, this.period, this.scheduler));
            }),
            t
          );
        })(),
        Ms = (function (t) {
          function e(e, n, r) {
            t.call(this, e),
              ...
              (this.scheduler = r),
              (this.hasValue = !1),
              this.add(r.schedule(Ts, n, { subscriber: this, period: n }));
          }
          return (
            Ss(e, t),
            (e.prototype._next = function (t) {
      ...
      (Y.Observable.prototype.sampleTime = {
        ...
        (Y.Observable.prototype.scan = {
          scan: function (t, e) {
            return arguments.length >= 2 ? Mo(t, e)(this) : Mo(t)(this);
          },
        }.scan);
      var js =
          (d && d.__extends) ||
        ...
        Is = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Es(t, this.compareTo, this.comparor));
            }),
            t
          );
        })(),
        Es = (function (t) {
          function e(e, n, r) {
            t.call(this, e),
              ...
              (this._b = []),
              (this._oneComplete = !1),
              this.add(n.subscribe(new As(e, this)));
          }
          return (
            js(e, t),
            (e.prototype._next = function (t) {
      ...
      var Fs =
        ...
        Vs = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Rs(t, this.predicate, this.source));
            }),
            t
          );
        })(),
      ...
      var Hs =
        ...
        Ys = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Ds(t, this.notifier));
            }),
            t
          );
        })(),
      ...
      var Ks = (function () {
        ...
        Zs = { ImmediateDefinition: Ks, Immediate: new Ks(O.root) },
        Qs =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
          ...
          AsapAction: (function (t) {
            ...
            return (
              ...
              (e.prototype.requestAsyncId = function (e, n, r) {
                return (
                  ...
                  null !== r && r > 0
                    ...
                    : (e.actions.push(this),
                      e.scheduled ||
                        (e.scheduled = Zs.Immediate.setImmediate(
                          e.flush.bind(e, null)
                        )))
                );
              }),
              (e.prototype.recycleAsyncId = function (e, n, r) {
                ...
                0 === e.actions.length &&
                  (Zs.Immediate.clearImmediate(n), (e.scheduled = void 0));
              }),
              e
            );
          })(Ne.AsyncAction),
        ...
        nc = {
          ...
          })(Ve.AsyncScheduler))(tc.AsapAction),
        },
        rc =
          (d && d.__extends) ||
          function (t, e) {
          ...
          SubscribeOnObservable: (function (t) {
            function e(e, n, r) {
              void 0 === n && (n = 0),
                ...
                (this.delayTime = n),
                (this.scheduler = r),
                (!je(n) || n < 0) && (this.delayTime = 0),
                (r && "function" == typeof r.schedule) ||
                  (this.scheduler = nc.asap);
            }
            return (
              rc(e, t),
              (e.create = function (t, n, r) {
        ...
        oc = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return new ic.SubscribeOnObservable(
                e,
                this.delay,
                this.scheduler
              ).subscribe(t);
      ...
      var sc =
        ...
        cc = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new uc(t, this.project, this.resultSelector));
            }),
            t
          );
        })(),
      ...
      (Y.Observable.prototype.switch = pc),
        (Y.Observable.prototype._switch = pc),
      ...
      var lc =
        ...
        hc = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new fc(t, this.observable, this.resultSelector)
              );
            }),
            t
          );
      ...
      (Y.Observable.prototype.take = {
        take: function (t) {
          return (function (t) {
            return function (e) {
              return 0 === t ? new vt.EmptyObservable() : e.lift(new dc(t));
            };
          })(t)(this);
        },
      }.take),
      ...
      var mc =
        ...
        vc = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new gc(t, this.notifier));
            }),
            t
          );
        })(),
      ...
      var _c =
        ...
        wc = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Oc(t, this.predicate));
            }),
            t
          );
        })(),
      ...
      Y.Observable.prototype.throttle = {
        throttle: function (t, e) {
          return (
            void 0 === e && (e = kc.defaultThrottleConfig),
            kc.throttle(t, e)(this)
          );
        },
      }.throttle;
      var xc =
      ...
      Y.Observable.prototype.throttleTime = {
        throttleTime: function (t, e, n) {
          return (
            void 0 === e && (e = Re.async),
            void 0 === n && (n = kc.defaultThrottleConfig),
            (function (t, e, n) {
              return (
                void 0 === e && (e = Re.async),
                void 0 === n && (n = kc.defaultThrottleConfig),
                function (r) {
                  return r.lift(new Cc(t, e, n.leading, n.trailing));
                }
              );
            })(
              t,
      ...
      var Mc =
        ...
        Ic = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new Ec(t, this.scheduler));
            }),
            t
          );
        })(),
          ...
          return (
            ...
            (e.prototype._next = function (t) {
              var e = this.scheduler.now(),
                n = e - this.lastTime;
              (this.lastTime = e), this.destination.next(new Tc(t, n));
            }),
            e
          );
        })(z.Subscriber);
        ...
        timeout: function (t, e) {
          return (
            ...
            (function (t, e) {
              ...
              return function (t) {
                return t.lift(new Vc(r, n, e, new Nc.TimeoutError()));
              };
            })(
              t,
              e
      ...
      var Dc =
        ...
        Gc = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new Xc(t, this.windowSize, this.startWindowEvery)
              );
            }),
            t
          );
      ...
      function tu(t) {
        ...
        (s.subscription = r.schedule(eu, e, {
          subscriber: n,
          window: o,
          context: s,
        })),
      ...
      var nu = function (t) {
        ...
        return (
          ...
          bt(arguments[2])
            ? (e = arguments[2])
            : je(arguments[2]) && (r = arguments[2]),
          bt(arguments[1])
            ? (e = arguments[1])
            : je(arguments[1]) && (n = arguments[1]),
          function (i) {
      ...
      var ru =
        ...
        iu = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(
                new ou(t, this.openings, this.closingSelector)
              );
            }),
            t
          );
      ...
      var su =
        ...
        cu = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new uu(t, this.closingSelector));
            }),
            t
          );
        })(),
      ...
      var au =
        ...
        pu = (function () {
          ...
          return (
            (t.prototype.call = function (t, e) {
              return e.subscribe(new lu(t, this.observables, this.project));
            }),
            t
          );
        })(),
      ...
      (Y.Observable.prototype.withLatestFrom = {
        withLatestFrom: function () {
          for (var t = [], e = 0; e < arguments.length; e++)
            t[e - 0] = arguments[e];
          return hu.withLatestFrom.apply(void 0, t)(this);
        },
      }.withLatestFrom),
        (Y.Observable.prototype.zip = {
          zipProto: function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e - 0] = arguments[e];
            return On.zip.apply(void 0, t)(this);
          },
        }.zipProto);
      Y.Observable.prototype.zipAll = {
        zipAll: function (t) {
          return (function (t) {
            return function (e) {
              return e.lift(new On.ZipOperator(t));
            };
          })(t)(this);
        },
      }.zipAll;
      var fu = {
              ...
              (t.prototype.logSubscribedFrame = function () {
                return (
                  this.subscriptions.push(
                    new fu.SubscriptionLog(this.scheduler.now())
                  ),
        ...
        vu = mu;
      du(mu, [bu.SubscriptionLoggable]);
      var gu = { ColdObservable: vu },
        _u =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        Ou = wu;
      du(wu, [bu.SubscriptionLoggable]);
      var ku = { HotObservable: Ou },
        xu =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        Pu = { VirtualTimeScheduler: Cu, VirtualAction: Su },
        Mu =
          (d && d.__extends) ||
          function (t, e) {
            for (var n in e) e.hasOwnProperty(n) && (t[n] = e[n]);
        ...
        Tu =
          ((function (t) {
            function e(e) {
              t.call(this, Pu.VirtualAction, 750),
            ...
            Mu(e, t),
              ...
              (e.prototype.createColdObservable = function (t, n, r) {
                ...
                var i = e.parseMarbles(t, n, r),
                  o = new gu.ColdObservable(i, this);
              ...
              (e.parseMarblesAsSubscriptions = function (t) {
                if ("string" != typeof t)
                  return new fu.SubscriptionLog(Number.POSITIVE_INFINITY);
                for (
                  var e = t.length,
                    n = -1,
                    r = Number.POSITIVE_INFINITY,
                ...
                return i < 0
                  ? new fu.SubscriptionLog(r)
                  : new fu.SubscriptionLog(r, i);
              }),
                  ...
                  var i = t.length,
                    ...
                    u =
                      "object" != typeof e
                        ...
                        : function (t) {
                            return r && e[t] instanceof gu.ColdObservable
                              ? e[t].messages
                              : e[t];
                          },
                    a = -1,
        ...
        ju = {
          RequestAnimationFrameDefinition: Tu,
          AnimationFrame: new Tu(O.root),
        },
        Iu =
          (d && d.__extends) ||
          function (t, e) {
            ...
            return (
              ...
              (e.prototype.requestAsyncId = function (e, n, r) {
                return (
                  ...
                  null !== r && r > 0
                    ...
                    : (e.actions.push(this),
                      e.scheduled ||
                        (e.scheduled = ju.AnimationFrame.requestAnimationFrame(
                          e.flush.bind(e, null)
                        )))
                );
              }),
              (e.prototype.recycleAsyncId = function (e, n, r) {
                if (
                  ...
                  return t.prototype.recycleAsyncId.call(this, e, n, r);
                0 === e.actions.length &&
                  (ju.AnimationFrame.cancelAnimationFrame(n),
                  (e.scheduled = void 0));
              }),
              e
            );
        ...
        Nu =
          ...
          })(Ve.AsyncScheduler))(Eu.AnimationFrameAction),
          nt.Subject);
      const Fu = new Intl.NumberFormat("ar-AE"),
        Vu = new Intl.NumberFormat("fa-IR"),
        Ru = {
          hour: (t) => Vu.format(t),
          minute: (t) => {
            let e = Vu.format(t);
            return 1 === e.length && (e = Vu.format(0) + e), e;
          },
          separator: ":",
          period: (t) =>
            "AM" === t ? "\u0635\u0628\u062d" : "\u0639\u0635\u0631",
          clockHour: (t) => Vu.format(t),
          clockMinute: (t) => Vu.format(t),
          labels: {
            ok: "\u062a\u0627\u06cc\u06cc\u062f",
            cancel: "\u0644\u063a\u0648",
          },
        ...
        Bu = {
          ...
          period: (t) =>
            "AM" === t
              ? "\u0635\u0628\u0627\u062d\u0627"
              : "\u0645\u0633\u0627\u0621",
          clockHour: (t) => Fu.format(t),
          clockMinute: (t) => Fu.format(t),
          labels: {
            ok: "\u062d\u0633\u0646\u0627",
            cancel: "\u0625\u0644\u063a\u0627\u0621",
          },
      ...
      let zu = (() => {
          class t {
            constructor(t, e, n) {
              (this.resolver = t), (this.appRef = e), (this.injector = n);
            }
            open(t) {
              ((t = {
                time: (t = t || {}).time || "00:00",
        ...
        Wu = (() => {
          class t {
            ...
            onClick(t) {
              const e = this.viewContainerRef.element.nativeElement,
                n = e.value,
                r = e.getAttribute("theme"),
                i = e.getAttribute("start"),
                o = e.getAttribute("end"),
                s = e.getAttribute("locale") || "en",
                c = "true" === e.getAttribute("changeToMinutes"),
                u = e.getAttribute("animation"),
                a = e.getAttribute("preference") || null,
                p = "true" === e.getAttribute("onlyHour"),
                l = "true" === e.getAttribute("onlyMinute"),
                h = "true" === e.getAttribute("onlyAM"),
                f = "true" === e.getAttribute("onlyPM");
              let b = e.getAttribute("arrowStyle");
              (b = b ? JSON.parse(b.replace(new RegExp("'", "g"), '"')) : ""),
                this.atp
                  .open({
                    time: n,
                    theme: r,
                    rangeTime: { start: i, end: o },
                    arrowStyle: b,
                    locale: s,
                    changeToMinutes: c,
                    animation: u,
                  ...
                  .afterClose()
                  .subscribe((t) => {
                    this.writeValue(t), this.onChange(t);
                  });
            }
            onInput(t) {
            ...
            writeValue(t) {
              this.elementRef && (this.elementRef.nativeElement.value = t);
            }
            registerOnChange(t) {
              this.onChange = t;
            }
