...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["demo-pages-catagory-catagory-module"], {
  ...
  function srcAppDemoPagesCatagoryCatagoryComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CatagoryComponent_tr_66_div_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CatagoryComponent_tr_66_div_4_Template_button_click_1_listener() {
          ...
          var subcat_r103 = ctx.$implicit;

          var ctx_r105 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          var _r91 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](31);

          _r91.show();

          return ctx_r105.updateSub(subcat_r103);
        });
    ...
    function CatagoryComponent_tr_66_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CatagoryComponent_tr_66_Template_button_click_11_listener() {
          ...
          var _r90 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](13);

          _r90.show();

          return ctx_r111.update(item_r98);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CatagoryComponent_tr_66_Template_button_click_13_listener() {
          ...
          return ctx_r113.remove(item_r98._id);
        });
    ...
    /*#__PURE__*/
    function () {
      function CatagoryComponent(toastEvent, fb, api, spiner, route, activeRoute, toster) {
      ...
      _createClass(CatagoryComponent, [{
            ...
            if (this.id) {
              this.api.updateCatogory(formdata, this.id).subscribe(function (res) {
                if (res.response = 'success') {
                  ...
                  _this2.toster.success('Catogory Updated');
                } else {
                  _this2.toster.success('Somthing Wrong!');
                }
              ...
              this.api.addCatogory(formdata).subscribe(function (res) {
                if (res.response = 'success') {
                  ...
                  _this2.toster.success('Catogory Created');
                } else {
                  _this2.toster.success('Somthing Wrong!');
                }
              });
          ...
          if (this.id) {
            this.api.updateSubCatogory(formdata, this.id).subscribe(function (res) {
              if (res.response = 'success') {
                ...
                _this3.toster.success('Catogory Updated!');
              } else {
                _this3.toster.success('Somthing Wrong!');
              }
            ...
            this.api.addSubCatogory(formdata).subscribe(function (res) {
              if (res.response = 'success') {
                ...
                _this3.toster.success('Catogory Created');
              } else {
                _this3.toster.success('Somthing Wrong!');
              }
            });
        ...
        value: function remove(id) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            ...
            if (willDelete.dismiss) {
              _this4.toster.success('Somthing Wrong!');
            } else {
              _this4.api.removeCatogory(id).subscribe(function (res) {
                _this4.toster.success('Catogory has been deleted!');
        ...
        value: function subremove() {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            ...
            if (willDelete.dismiss) {
              _this5.toster.success('Somthing Wrong!');
            } else {
              _this5.api.removeSubCatogory(_this5.id).subscribe(function (res) {
                _this5.toster.success('Catogory has been deleted!');
    ...
    CatagoryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_theme_shared_components_card_card_component__WEBPACK_IMPORTED_MODULE_9__["CardComponent"], _theme_shared_components_modal_ui_modal_ui_modal_component__WEBPACK_IMPORTED_MODULE_10__["UiModalComponent"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroupDirective"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControlName"], _angular_common__WEBPACK_IMPORTED_MODULE_11__["NgClass"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["SelectControlValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NgSelectOption"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ɵangular_packages_forms_forms_x"], _angular_common__WEBPACK_IMPORTED_MODULE_11__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_11__["NgIf"]],
